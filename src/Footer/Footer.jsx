...
export default function Footer() {
  return (
    <div className="bg-[#111827] w-full">
      <footer className="">
        <div className="max-w-screen-xl mx-auto px-4 py-12 flex flex-wrap justify-between">
        {/* div1 */}
        <div className="flex-1 md:w-1/5 px-4 mb-8">
  ...
  <div className="max-w-screen-xl mx-auto flex justify-between items-center flex-wrap md:flex-nowrap px-4">
    {/* Copyright Text */}
    <p className="text-gray-400 text-sm text-center sm:text-left md:text-left w-full md:w-auto mb-2 md:mb-0">
      Copyright © 2023
    </p>
    ...
    {/* Designed By */}
    <p className="text-gray-400 text-sm text-center md:text-right w-full md:w-auto">
