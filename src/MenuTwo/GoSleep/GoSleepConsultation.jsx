...
export default function GoSleepConsultation() {
  return (
    <div className='max-w-screen-xl mx-auto bg-[#325980] rounded-tr-3xl rounded-bl-3xl p-8 mb-10'>
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        <div className='w-full md:w-1/2 flex flex-col justify-center md:py-10 px-5 gap-4'>
          ...
          <div className='flex items-center mt-4'>
            <button className='bg-white text-[#325980] px-4 py-2 rounded-full inline-flex items-center gap-2 hover:bg-green-50 transition duration-200'>
              Book Consultation
