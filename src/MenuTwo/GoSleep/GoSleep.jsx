...
const productData = {
  ...
  description: 'GoSleep is an Ayurvedic Proprietary Medicine for sound sleep. Based on the science of Sattva Therapy, this formulation works on the root cause and helps in improving the sleep cycle.',
  logos: [
...
export default function GoSleep() {
  ...
  {productData.packs.map((pack, index) => (
    <div key={index} className='border p-4 rounded-lg relative overflow-hidden bg-[#eff4f9]'>
      ...
      <p className='text-lg font-bold text-Black'>{pack.discountedPrice}</p>
        ...
        {/* Buy Buttons */}
        <div className='grid grid-cols-2 gap-4'>
          <button className='bg-[#325980] hover:bg-[#27537f] text-white font-bold py-2 px-4 rounded-full flex items-center justify-center'>
            {productData.buyButtons.amazon}
            <img src='amazon-logo.png' alt="Amazon Logo" className='w-5 h-5 mr-2' />
          </button>
          <button className='bg-white border-2 border-[#325980]  text-[#325980] font-bold py-2 px-4 rounded-full'>
    ...
    <div className='w-full text-center pt-5 pb-5'>
      ...
      <div className='w-full flex flex-col md:flex-row gap-6'>
        {/* left */}
      <div className='flex w-full md:w-1/2 border-2 py-4 px-4 rounded-tr-3xl rounded-bl-3xl bg-[#eff4f9] '>
        <div className='flex w-full md:w-[60%] '>
          <div className='flex flex-col'>
        <h1 className='text-black text-xl font-bold'>How to consume?</h1>
        <p className='text-black text-lg pt-3'>Consume one GoSleep  tablet daily at bedtime with water</p>
        </div>
        </div>
      ...
      {/* right */}
      <div className='flex w-full md:w-1/2 border-2 py-2 px-4 rounded-tr-3xl rounded-bl-3xl bg-[#eff4f9]'>
        <div className='flex w-full md:w-[60%] '>
          <div className='flex flex-col'>
