    ...
    <div className='max-w-screen-xl mx-auto pb-10'>
      <div className='w-full flex md:flex-col'>
        <h2 className='text-black text-3xl font-bold text-center mb-10'>Meet Our Executive Members</h2>
            <p className='text-black text-xl text-center mb-10'>People from different field and different prospective about human health came together to make ayurveda more validated & accepted.</p>
      </div>
