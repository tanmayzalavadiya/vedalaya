...
export default function Science() {
  ...
  return (
    <div className='mt-10'>
      <h1 className='max-w-screen-xl mx-auto text-black text-3xl font-bold text-center mb-[30px]'>
        SCIENCE BEHIND VEDALAY PRODUCTS
      </h1>
      <div className='bg-[#74b0d24d]'>
        <div className='max-w-screen-xl mx-auto flex flex-col md:flex-row mb-10'>
          {/* left part */}
          ...
          <div className='w-full md:w-2/3 flex flex-col justify-center text-center md:text-right space-y-1 mt-5 mb-5'>
            <h3 className='text-white bg-[#3d6787] text-center md:self-end w-42'>The Positive in You</h3>
            <h2 className='text-[#3d6787] font-bold text-4xl self-end'>Sattva Therapy</h2>
            <p className='text-sm text-[#3d6787] self-end'>The therapy that works on manas (Mind) Gunas like</p>
            ...
            <div className='pt-2 pb-2'>
              <p className='text-[#3d6787] text-right'>The basic fundament that makes VEDALAY unique from others. It works in mainly to improve your Mind Immunity help you cure from within rather than just pacifying symptoms.</p>
            </div>
